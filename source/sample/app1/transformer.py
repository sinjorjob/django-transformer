...
class FeedForward(nn.Module):
    def __init__(self, d_model, d_ff=1024, dropout=0.1):
        ...
        self.linear_1 = nn.Linear(d_model, d_ff)  # torch.Size([8, 256, 1024])
        self.dropout = nn.Dropout(dropout)  # torch.Size([8, 256, 1024])
        self.linear_2 = nn.Linear(d_ff, d_model)  # torch.Size([8, 256,300])
